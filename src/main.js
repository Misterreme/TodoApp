...
function createButtons() {
    ...
    editButton.setAttribute("class", "inline-block w-8 h-8 cursor-pointer bg-no-repeat bg-cover bg-center");
    editButton.style.backgroundImage = "url('./src/assets/icons/edit-icon.png')";
    ...
    deleteButton.setAttribute("class", "inline-block w-8 h-8 cursor-pointer bg-no-repeat bg-cover bg-center");
    deleteButton.style.backgroundImage = "url('./src/assets/icons/remove-icon.webp')";
