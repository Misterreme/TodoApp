...
function createButtons() {
    ...
    editButton.setAttribute("class", "inline-block w-8 h-8 cursor-pointer bg-[url('./icons/edit-icon.png')] bg-no-repeat bg-cover bg-center");
    ...
    deleteButton.setAttribute("class", "inline-block w-8 h-8 cursor-pointer bg-[url('./icons/remove-icon.webp')] bg-no-repeat bg-cover bg-center");
